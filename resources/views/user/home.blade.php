...
@endphp
@foreach( $all_products as $view_product)
<div class="col-sm-3">
    ...
    <div class="product-image-wrapper">
        ...
        <div class="choose">
            <ul class="nav nav-pills nav-justified">
                <li><a href="{{ url('/view-product/' .$view_product->product_id) }}"></i>View Product</a></li>
                <li><a href="{{ url('/product_by_brand/' .$view_product->brand_id) }}">{{$view_product->brand_name}}</a></li>
            </ul>
        </div>
    </div>
</div>
